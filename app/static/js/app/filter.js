...
export default {
     ...
     */
    filter_addFilter(filterKey, filterValue, displayText, filterType = 'default') {
        if (!window._dashboardFilters) {
            this.filter_initializeFilterState();
        }
     ...
     */
    filter_toggleFilter(filterKey, filterValue, displayText, filterType = 'default') {
    ...
    filter_renderFilters() {
        ...
        if (!hasFilters) {
            ...
            emptyState.innerHTML = '<i class="fas fa-filter"></i> <span>Nenhum filtro ativo</span>';
